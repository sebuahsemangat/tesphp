...
?>
<div class="row">
    <div class="col"><?php echo "<h3>Nilai: " . $row_ujian["nama_ujian"] . "</h3>";?></div>
    ...
    <tbody>
        ...
        if ($result_siswa->num_rows > 0) {
            while ($row_siswa = $result_siswa->fetch_assoc()) {
                ...
                <tr>
                    <td><?php echo $no++; ?></td>
                    <td><?php echo htmlspecialchars($row_siswa['nis']); ?></td>
                    <td><?php echo htmlspecialchars($row_siswa['nama']); ?></td>
                    <td><?php echo htmlspecialchars($row_siswa['nama_kelas']); ?></td>
